...
export function FloatingButtons() {
  ...
  return (
    <>
      ...
      <div className={styles.leftButtons} role="complementary" aria-label="Quick contact buttons">
        <motion.a
        ...
        >
          <Phone size={22} />
          <span className={styles.fabLabel}>Call Now</span>
        </motion.a>
      </div>
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            className={`${styles.fab} ${styles.scrollTop}`}
            onClick={scrollToTop}
